        ...
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Capture. Edit. Share Instantly.</h2>
              <p className="text-white/60 mb-8">Professional screenshots made simple.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
              ...
              <div className="flex items-center justify-center">
                <a href="https://github.com/KartikLabhshetwar/better-shot/releases/latest" target="_blank" rel="noopener noreferrer">
